 import { UserManagmentPage } from "/fixtures/Pages/UserManagmentPage"
...
describe('Admin Login', () => {
  ...
  it('Admin delete become active after login', () => {
    adminLogin('admin@example.com', 'admin123')
    UserManagmentPage.userTableRow().eq(0).within(() => {
  ...
  it('Check the UI of the Login As Admin section', () => {
      ...
      UserManagmentPage.adminLoginButton().should('be.visible')
...
describe('Add New User', () => {
  ...
  it(' Check the UI of the Add New User section', () => {
      ...
      UserManagmentPage.userGenderMale().parents('label').parent().siblings('label').should('be.visible')
      .should('have.text', 'Gender')
      UserManagmentPage.userInputNewsletter().parents('label').parent().siblings('label')
      .should('be.visible').should('have.text', 'Subscribe to')
      UserManagmentPage.userButtonSave().should('be.visible')
...
describe('User Table', () => {
  ...
  it('Deactivate a user(logged out user)', () => {
    ...
    UserManagmentPage.userTableRow().first().find('td').eq(6).should('have.text', 'Active')
      ...
      UserManagmentPage.userTableRow().first().find('td').find('.btn-primary.status-btn')
