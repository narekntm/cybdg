...
describe.only('User Management', () => {
    ...
    describe('Login As Admin', () => {
        ...
        it('8. Check the UI of the Login As Admin section', () => {
            UserManagementPage.adminControlsPanel().prev().should('be.visible').should('have.text', 'Login as Admin')
            ...
            UserManagementPage.adminLoginBtn().should('be.visible')
    ...
    describe('Add New User', () => {
        it('1. New user creation in a viewer mode', () => {
            userCreation()
            UserManagementPage.userTableData().last().find('td').eq(0).should('have.text', 'Ani')
        })
        ...
        it('12. Check the UI of the Add New User section', () => {
            ...
            UserManagementPage.userGenderLabel().should('be.visible').should('have.text', 'Gender')
    ...
    describe('User Table', () => {
        it('1. Trying to delete a user while being logged out', () => {
            UserManagementPage.adminLogoutBtn().should('not.be.visible')
            UserManagementPage.userTableData().should('have.length', 3)
            UserManagementPage.userTableData().first().find('td').find('.btn-danger.delete-btn').click()
            UserManagementPage.userDeleteValidationError()
        ...
        it('4. Deactivate a user(logged out user)', () => {
            UserManagementPage.adminLogoutBtn().should('not.be.visible')
            UserManagementPage.userTableData().first().find('td').eq(6).should('have.text', 'Active')
            UserManagementPage.userTableData().first().find('td').find('.btn-primary.status-btn')
            .should('have.text', 'Deactivate').click()
            UserManagementPage.userTableData().first().find('td').find('.btn-primary.status-btn')
            .should('have.text', 'Activate')
            UserManagementPage.userTableData().first().find('td').eq(6).should('have.text', 'Inactive')
        })
        ...
        it('6. Activate a user(logged out user)', () => {
            UserManagementPage.adminLogoutBtn().should('not.be.visible')
            UserManagementPage.userTableData().eq(1).find('td').eq(6).should('have.text', 'Inactive')
            UserManagementPage.userTableData().eq(1).find('td').find('.btn-primary.status-btn')
            .should('have.text', 'Activate').click()
            UserManagementPage.userTableData().eq(1).find('td').find('.btn-primary.status-btn')
            .should('have.text', 'Deactivate')
            UserManagementPage.userTableData().eq(1).find('td').eq(6).should('have.text', 'Active')
        })
        ...
        it('8. Make sure the Edit User section becomes active when clicking on the Edit button(logged out user)', () => {
            UserManagementPage.adminLogoutBtn().should('not.be.visible')
            UserManagementPage.userTableData().first().find('td').eq(0).should('have.text', 'Alice')
            UserManagementPage.userFormTitle().should('be.visible').should('have.text', 'Add New User')
            UserManagementPage.userTableData().first().find('td').find('.btn-secondary.edit-btn').click()
        ...
        it('10. Check that the user update flow works properly(logged out user)', () => {
            UserManagementPage.adminLogoutBtn().should('not.be.visible')
            UserManagementPage.userTableData().first().find('td').eq(0).should('have.text', 'Alice')
            UserManagementPage.userTableData().first().find('td').eq(1).should('have.text', 'Admin')
            UserManagementPage.userTableData().first().find('td').eq(2).should('have.text', '30')
            UserManagementPage.userTableData().first().find('td').eq(3).should('have.text', 'alice@site.com')
            UserManagementPage.userTableData().first().find('td').eq(4).should('have.text', 'Female')
            UserManagementPage.userFormTitle().should('be.visible').should('have.text', 'Add New User')
            UserManagementPage.userTableData().first().find('td').find('.btn-secondary.edit-btn').click()
            UserManagementPage.userFormTitle().should('be.visible').should('have.text', 'Edit User')
            ...
            UserManagementPage.userSaveBtn().click()
            UserManagementPage.userFormTitle().should('be.visible').should('have.text', 'Add New User')
            UserManagementPage.userTableData().first().find('td').eq(0).should('have.text', 'Max')
            UserManagementPage.userTableData().first().find('td').eq(1).should('have.text', 'Viewer')
            UserManagementPage.userTableData().first().find('td').eq(2).should('have.text', '26')
            UserManagementPage.userTableData().first().find('td').eq(3).should('have.text', 'example@test.com')
            UserManagementPage.userTableData().first().find('td').eq(4).should('have.text', 'Male')
        })
