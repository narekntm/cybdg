export class UserManagementPageV2 {
  ...
  static openEditForUser = (name: string) => UserManagementPageV2.userRow(name).find(".edit-btn").click();
  static openDeleteForUser = (name: string) => UserManagementPageV2.userRow(name).find(".delete-btn").click();
  static toggleStatusForUser = (name: string) => UserManagementPageV2.userRow(name).find(".status-btn").click();
  static userStatusCell = (name: string) => UserManagementPageV2.userRow(name).find("td").eq(6);
